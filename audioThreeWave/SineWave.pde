...
class SumWave {
  ...
  void setFreq(int waveIndex, float freq) {
    sineWaves.get(waveIndex).setFrequency(freq);
  }

  void setFirstWaveFrequency(float freq) {
    setFreq(0, freq);
  }

  void setSecondWaveFrequency(float freq) {
    setFreq(1, freq);
  }

  void setThirdWaveFrequency(float freq) {
    setFreq(2, freq);
  }

  void setThirdInclude(boolean in) {
